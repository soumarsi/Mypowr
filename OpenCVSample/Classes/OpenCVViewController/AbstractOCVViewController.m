...
- (void)viewDidLoad
{
    ...
    //_imageView.image = [UIImage imageNamed:@"clocks.jpg"];
    //IplImage *src = [self CreateIplImageFromUIImage:_imageView.image];
    
    //[self didCaptureIplImage:src];
}

- (IplImage *)CreateIplImageFromUIImage:(UIImage *)image {
    NSLog(@"CreateIplImageFromUIImage    in abstract vi=ew controller...........");
